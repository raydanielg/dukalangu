    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-branding">
            <div class="branding-content">
                <!-- Logo -->
                <div class="logo-section" style="animation: fadeIn 1s ease-out;">
                    <img src="{{ asset('Salama logo.png') }}" alt="{{ config('app.name') }}" class="salamapay-logo" style="width: 120px; height: auto; margin-bottom: 16px;">
                </div>

                <!-- Decorative Line -->
                <div class="decorative-line" style="width: 60px; height: 3px; background: linear-gradient(90deg, var(--primary-green-light), var(--primary-green), var(--primary-green-dark)); margin: 0 auto 20px; border-radius: 2px; animation: expandLine 1s ease-out;"></div>
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('login') }}" class="login-form">
                    ...
                    <div class="social-login" style="display: flex; flex-direction: column; gap: 12px;">
                        <!-- Google Sign In -->
                        <a href="{{ url('auth/google') }}" class="social-btn" style="display: flex; align-items: center; justify-content: center; gap: 10px; padding: 12px; border: 1px solid var(--border-color); border-radius: 8px; text-decoration: none; color: var(--text-dark); font-weight: 500; transition: all 0.2s; background: white;">
                        ...
                        <!-- Facebook Sign In -->
                        <a href="{{ url('auth/facebook') }}" class="social-btn" style="display: flex; align-items: center; justify-content: center; gap: 10px; padding: 12px; border: 1px solid var(--border-color); border-radius: 8px; text-decoration: none; color: var(--text-dark); font-weight: 500; transition: all 0.2s; background: white;">
                            <svg width="20" height="20" viewBox="0 0 24 24">
                        ...
                        <!-- Twitter/X Sign In -->
                        <a href="{{ url('auth/twitter') }}" class="social-btn" style="display: flex; align-items: center; justify-content: center; gap: 10px; padding: 12px; border: 1px solid var(--border-color); border-radius: 8px; text-decoration: none; color: var(--text-dark); font-weight: 500; transition: all 0.2s; background: white;">
                            <svg width="20" height="20" viewBox="0 0 24 24">
