...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  void _showWelcomeNotification(String userName, {bool isFirstTime = false}) {
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Icon(
                            isFirstTime ? Icons.celebration_outlined : Icons.check_circle_outline,
                            color: Colors.white,
                            size: 28,
                          ),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                isFirstTime ? 'Welcome to SalamaPay! 🎉' : 'Welcome back! 🎉',
                                style: GoogleFonts.nunito(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600,
